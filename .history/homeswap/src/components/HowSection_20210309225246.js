    ...
    >
      ...
      <div className="container">
        <div className="card card-one">
          ...
          <p>
            {" "}
            Fill in the required fields and upload pictures. To prevent too many
            from being placed, a maximum of 3 ads per user has been set. By
            specifying 3 advertisements with different places of residence and a
            large radius, an area of ​​almost half of the whole of the
            Netherlands can be covered!
          </p>
        </div>
        <div className="card card-two">
          ...
          <p>
            To prevent too many from being placed, a maximum of 3 ads per user
            has been set. By specifying 3 advertisements with different places
            of residence and a large radius, an area of ​​almost half of the
            whole of the Netherlands can be covered!
          </p>
        </div>
